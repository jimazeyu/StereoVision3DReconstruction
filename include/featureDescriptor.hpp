 ...
 * @LastEditTime: 2022-06-08 10:03:00
 * @FilePath: /Stereo_Bighomework/include/featureDescriptor.hpp
 * @Description: 计算特征描述符
 * @Version: 1.0
 */
#ifndef _FEATURE_DESCRIPTOR_HPP_
#define _FEATURE_DESCRIPTOR_HPP_
...
/**
 * @description: 计算ORB描述符
 * @param {Mat} &img
 * @param {vector<cv::KeyPoint>} &keypoints
 * @param {vector<vector<uint32_t>>} &descriptors
 * @return {*}
 * @author: Jimazeyu
 */
void ComputeORB(const cv::Mat &img, vector<cv::KeyPoint> &keypoints, vector<vector<uint32_t>> &descriptors)
{
